...
% // ==================== Test: XXZ spin chain ============================
% Hamiltonian [../SpinModel/SpinModel_XXZtest.m]: 
...
% CmDataFile = {'FileName1'; 'FileName2'; ...};K
CmDataFile = {'../ExpData/XXZtest_C_Jxy=1_Jz=1.5_gz=2_0T.mat'; % zero field
             '../ExpData/XXZtest_C_Jxy=1_Jz=1.5_gz=2_1T.mat';  % 1T data
             '../ExpData/XXZtest_C_Jxy=1_Jz=1.5_gz=2_2T.mat'}; % 2T data


% CmDataTRange: the temperature range to be fitted (Unit: K)
% Temperatuare Range used in the fitting, [3, 20] Kelvin recomended
% (Lowest available T: 0.1K, highest T: 24K) 
...
ChiDataFile = {'../ExpData/XXZtest_Chi_Jxy=1_Jz=1.5_g=2_Sx.mat';
               '../ExpData/XXZtest_Chi_Jxy=1_Jz=1.5_g=2_Sz.mat'};

% ChiDataTRange: the temperature range to be fitted (Unit: K)
% ChiDataTRange = {[T1l, T1u]; [T2l, T2u]; ...};
ChiDataTRange = {[3, 20], [3, 20]};
