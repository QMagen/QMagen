...
%       H = sum_i Jxy(Sx_i Sx_i+1 + Sy_i Sy_i+1) + Jz Sz_i Sz_i+1
% Fitting Data [../ExpData] (generated by iLTRG with Jxy = 1 K, Jz = 1.5 K, gx = gz = 2): 
%       specific heat (0 Tesla)
...
CmDataFile = {'../ExpData/XXZtest_C_Jxy=1_Jz=1.5_gz=2_1T.mat'};
