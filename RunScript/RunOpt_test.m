...
CmDataFile = {'../ExpData/XXZtest_C_Jxy=1_Jz=1.5_gz=2_0T.mat', ...
              '../ExpData/XXZtest_C_Jxy=1_Jz=1.5_gz=2_1T.mat', ...
              '../ExpData/XXZtest_C_Jxy=1_Jz=1.5_gz=2_2T.mat'};

% CmDataTRange: the temperature range to be fitted (Unit: K)
% CmDataTRange = {[T1l, T1u]; [T2l, T2u]; ...};
CmDataTRange = {[3, 20], [3, 20], [3, 20]};

% CmDataField: the magnetic filed of experimantal data (Unit: Tesla)
% CmDataField = {[B1x, B1y, B1z]; [B2x, B2y, B2z]; ...};
CmDataField = {[0, 0, 0], [0, 0, 1], [0, 0, 2]};
...
ChiDataFile = {'../ExpData/XXZtest_Chi_Jxy=1_Jz=1.5_gz=2_Sz.mat'};
