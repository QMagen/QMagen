...
% ======================== Test : XXZ spin chain ========================= %
% Hamiltonian: 
% Input: Specific heat (under 0, 1, 2 T), magnetic susceptibility \chi_xy & \chi_z
% (generated by iLTRG from XXZ chain with parameters Jxy=1 K, Jz = 1.5 K, g=2)
% Target: Find parameters Jxy, Jz, and Lande factor g
% Method: Bayesian Optimization
% Solver: ED, iLTRG, XTRG
% Reminder: If more 
% ======================================================================== %

% // ==================== User Input: Parameters ==========================
Para.ManyBodySolver = 'ED'; % 'ED', 'ED_C', 'iLTRG', 'XTRG'
